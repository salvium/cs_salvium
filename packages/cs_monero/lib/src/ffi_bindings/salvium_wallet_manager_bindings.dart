...
Pointer<Void> getWalletManager() {
  return bindings.SALVIUM_WalletManagerFactory_getWalletManager();
}
...
Pointer<Void> createWallet(
  ...
  try {
    return bindings.SALVIUM_WalletManager_createWallet(
...
Pointer<Void> openWallet(
  ...
  try {
    return bindings.SALVIUM_WalletManager_openWallet(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      networkType,
...
Pointer<Void> recoveryWallet(
  ...
  try {
    return bindings.SALVIUM_WalletManager_recoveryWallet(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      mnemonicPointer,
...
Pointer<Void> createWalletFromKeys(
  ...
  try {
    return bindings.SALVIUM_WalletManager_createWalletFromKeys(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      languagePointer,
...
Pointer<Void> createDeterministicWalletFromSpendKey(
  ...
  try {
    return bindings.SALVIUM_WalletManager_createDeterministicWalletFromSpendKey(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      languagePointer,
...
Pointer<Void> createWalletFromPolyseed(
  ...
  try {
    return bindings.SALVIUM_WalletManager_createWalletFromPolyseed(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      networkType,
...
bool closeWallet(
  ...
  final closeWallet = bindings.SALVIUM_WalletManager_closeWallet(
    walletManagerPointer,
    walletPointer,
    store,
  );
...
bool walletExists(Pointer<Void> walletManagerPointer, String path) {
  ...
  try {
    return bindings.SALVIUM_WalletManager_walletExists(
      walletManagerPointer,
      pathPointer,
    );
  } finally {
