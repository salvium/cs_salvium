...
import 'salvium_bindings_base.dart';

/// Will throw on failure
void checkWalletStatus(Pointer<Void> walletPointer) {
  final status = bindings.SALVIUM_Wallet_status(walletPointer);

  if (status == 0) {
    return;
  }
  final stringPointer = bindings.SALVIUM_Wallet_errorString(
    walletPointer,
  ).cast<Utf8>();
...
bool storeWallet(Pointer<Void> walletPointer, {required String path}) {
  ...
  try {
    return bindings.SALVIUM_Wallet_store(walletPointer, pathPointer);
  } finally {
...
bool initWallet(
  ...
  try {
    return bindings.SALVIUM_Wallet_init(
      walletPointer,
...
void setTrustedDaemon(Pointer<Void> walletPointer, {required bool arg}) {
  bindings.SALVIUM_Wallet_setTrustedDaemon(walletPointer, arg);
}

bool isWatchOnly(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_watchOnly(walletPointer);
}

int isConnected(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_connected(walletPointer);
}

bool isSynchronized(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_synchronized(walletPointer);
}

String getWalletPath(Pointer<Void> walletPointer) {
  final stringPointer =
      bindings.SALVIUM_Wallet_path(walletPointer).cast<Utf8>();
...
bool validateAddress(String address, int networkType) {
  ...
  try {
    return bindings.SALVIUM_Wallet_addressValid(addressPointer, networkType);
  } finally {
...
String getWalletAddress(
  ...
  final stringPointer = bindings.SALVIUM_Wallet_address(
    walletPointer,
    accountIndex,
    addressIndex,
  ).cast<Utf8>();
...
int getWalletBlockChainHeight(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_blockChainHeight(walletPointer);
}

int getDaemonBlockChainHeight(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_daemonBlockChainHeight(walletPointer);
}
...
void setWalletRefreshFromBlockHeight(
  ...
  bindings.SALVIUM_Wallet_setRefreshFromBlockHeight(
    walletPointer,
...
int getWalletRefreshFromBlockHeight(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_getRefreshFromBlockHeight(walletPointer);
}
...
void setWalletAutoRefreshInterval(
  ...
  bindings.SALVIUM_Wallet_setAutoRefreshInterval(walletPointer, millis);
}

void refreshWalletAsync(Pointer<Void> walletPointer) {
  bindings.SALVIUM_Wallet_refreshAsync(walletPointer);
}

void startWalletRefresh(Pointer<Void> walletPointer) {
  bindings.SALVIUM_Wallet_startRefresh(walletPointer);
}

void pauseWalletRefresh(Pointer<Void> walletPointer) {
  bindings.SALVIUM_Wallet_pauseRefresh(walletPointer);
}

void stopWallet(Pointer<Void> walletPointer) {
  bindings.SALVIUM_Wallet_stop(walletPointer);
}

bool rescanWalletBlockchain(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_rescanBlockchain(walletPointer);
}
...
int getWalletBalance(Pointer<Void> walletPointer, {required int accountIndex}) {
  return bindings.SALVIUM_Wallet_balance(walletPointer, accountIndex);
}
...
int getWalletUnlockedBalance(
  ...
  return bindings.SALVIUM_Wallet_unlockedBalance(walletPointer, accountIndex);
}
...
String getTxKey(Pointer<Void> walletPointer, {required String txid}) {
  ...
  try {
    final stringPointer = bindings.SALVIUM_Wallet_getTxKey(
      walletPointer,
      txidPointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
Pointer<Void> getTransactionHistoryPointer(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_history(walletPointer);
}

void refreshTransactionHistory(Pointer<Void> txHistoryPointer) {
  bindings.SALVIUM_TransactionHistory_refresh(txHistoryPointer);
}

int getTransactionHistoryCount(Pointer<Void> txHistoryPointer) {
  return bindings.SALVIUM_TransactionHistory_count(txHistoryPointer);
}
...
Pointer<Void> getTransactionInfoPointer(
  ...
  return bindings.SALVIUM_TransactionHistory_transaction(
    txHistoryPointer,
    index,
  );
}
...
Pointer<Void> getTransactionInfoPointerByTxid(
  ...
  final txidPointer = txid.toNativeUtf8().cast<Char>();
  try {
    return bindings.SALVIUM_TransactionHistory_transactionById(
      txHistoryPointer,
      txidPointer,
    );
  } finally {
...
Pointer<Void> createTransaction(
  ...
  try {
    return bindings.SALVIUM_Wallet_createTransaction(
      walletPointer,
      addressPointer,
      paymentIdPointer,
      amount,
...
Pointer<Void> createTransactionMultiDest(
  ...
  try {
    return bindings.SALVIUM_Wallet_createTransactionMultDest(
      walletPointer,
...
void checkPendingTransactionStatus(Pointer<Void> pendingTransactionPointer) {
  final status = bindings.SALVIUM_PendingTransaction_status(
    pendingTransactionPointer,
  );
  if (status == 0) {
    return;
  }
  final stringPointer = bindings.SALVIUM_PendingTransaction_errorString(
    pendingTransactionPointer,
  ).cast<Utf8>();
...
int getPendingTransactionAmount(Pointer<Void> pendingTransactionPointer) {
  return bindings.SALVIUM_PendingTransaction_amount(pendingTransactionPointer);
}

int getPendingTransactionFee(Pointer<Void> pendingTransactionPointer) {
  return bindings.SALVIUM_PendingTransaction_fee(pendingTransactionPointer);
}
...
String getPendingTransactionTxid(
  ...
  try {
    final stringPointer = bindings.SALVIUM_PendingTransaction_txid(
      pendingTransactionPointer,
      separatorPointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
String getPendingTransactionHex(
  ...
  final separatorPointer = separator.toNativeUtf8().cast<Char>();
  try {
    final stringPointer = bindings.SALVIUM_PendingTransaction_hex(
      pendingTransactionPointer,
      separatorPointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
bool commitPendingTransaction(
  ...
  try {
    return bindings.SALVIUM_PendingTransaction_commit(
      pendingTransactionPointer,
      filenamePointer,
      overwrite,
    );
...
Pointer<Void> getCoinsPointer(Pointer<Void> walletPointer) {
  return bindings.SALVIUM_Wallet_coins(walletPointer);
}

void refreshCoins(Pointer<Void> coinsPointer) {
  bindings.SALVIUM_Coins_refresh(coinsPointer);
}

int getCoinsCount(Pointer<Void> coinsPointer) {
  return bindings.SALVIUM_Coins_count(coinsPointer);
}

int getAllCoinsSize(Pointer<Void> coinsPointer) {
  return bindings.SALVIUM_Coins_getAll_size(coinsPointer);
}

Pointer<Void> getCoinInfoPointer(Pointer<Void> coinsPointer, int index) {
  return bindings.SALVIUM_Coins_coin(coinsPointer, index);
}

void freezeCoin(Pointer<Void> coinsPointer, {required int index}) {
  bindings.SALVIUM_Coins_setFrozen(coinsPointer, index);
}

void thawCoin(Pointer<Void> coinsPointer, {required int index}) {
  bindings.SALVIUM_Coins_thaw(coinsPointer, index);
}
...
int getInternalOutputIndexForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.SALVIUM_CoinsInfo_internalOutputIndex(coinsInfoPointer);
}

bool isFrozenCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.SALVIUM_CoinsInfo_frozen(coinsInfoPointer);
}

bool isSpentCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.SALVIUM_CoinsInfo_spent(coinsInfoPointer);
}

int getSpentHeightForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.SALVIUM_CoinsInfo_spentHeight(coinsInfoPointer);
}

int getAmountForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.SALVIUM_CoinsInfo_amount(coinsInfoPointer);
}
...
bool isCoinbaseCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.SALVIUM_CoinsInfo_coinbase(coinsInfoPointer);
}

String getAddressForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  final stringPointer = bindings.SALVIUM_CoinsInfo_address(
    coinsInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getKeyImageForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  final stringPointer = bindings.SALVIUM_CoinsInfo_keyImage(
    coinsInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
bool exportWalletKeyImages(
  ...
  final filenamePointer = filename.toNativeUtf8().cast<Char>();
  try {
    return bindings.SALVIUM_Wallet_exportKeyImages(
      walletPointer,
      filenamePointer,
      all,
    );
...
bool importWalletKeyImages(Pointer<Void> walletPointer, String filename) {
  ...
  try {
    return bindings.SALVIUM_Wallet_importKeyImages(
      walletPointer,
      filenamePointer,
    );
  } finally {
...
String signMessageWith(
  ...
  final addressPointer = address.toNativeUtf8().cast<Char>();
  try {
    final stringPointer = bindings.SALVIUM_Wallet_signMessage(
      walletPointer,
      messagePointer,
      addressPointer,
    ).cast<Utf8>();
...
bool verifySignedMessageWithWallet(
  ...
  try {
    return bindings.SALVIUM_Wallet_verifySignedMessage(
      walletPointer,
      messagePointer,
      addressPointer,
      signaturePointer,
...
String getWalletSeed(
  ...
  try {
    final stringPointer =
        bindings.SALVIUM_Wallet_seed(walletPointer, seedOffsetPointer)
            .cast<Utf8>();
    return convertAndFree(stringPointer);
  } finally {
...
String getWalletSeedLanguage(Pointer<Void> walletPointer) {
  final stringPointer =
      bindings.SALVIUM_Wallet_getSeedLanguage(walletPointer).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletPolyseed(
  ...
  try {
    final stringPointer = bindings.SALVIUM_Wallet_getPolyseed(
      walletPointer,
      passphrasePointer,
    ).cast<Utf8>();
...
String createPolyseed({String language = "English"}) {
  ...
  try {
    final stringPointer = bindings.SALVIUM_Wallet_createPolyseed(
...
bool setWalletPassword(
  ...
  try {
    return bindings.SALVIUM_Wallet_setPassword(walletPointer, passwordPointer);
  } finally {
...
String getWalletPassword(Pointer<Void> walletPointer) {
  final stringPointer = bindings.SALVIUM_Wallet_getPassword(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletSecretViewKey(Pointer<Void> walletPointer) {
  final stringPointer = bindings.SALVIUM_Wallet_secretViewKey(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletPublicViewKey(Pointer<Void> walletPointer) {
  final stringPointer = bindings.SALVIUM_Wallet_publicViewKey(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletSecretSpendKey(Pointer<Void> walletPointer) {
  final stringPointer = bindings.SALVIUM_Wallet_secretSpendKey(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletPublicSpendKey(Pointer<Void> walletPointer) {
  final stringPointer = bindings.SALVIUM_Wallet_publicSpendKey(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
int getTransactionInfoAmount(Pointer<Void> txInfoPointer) {
  return bindings.SALVIUM_TransactionInfo_amount(txInfoPointer);
}

int getTransactionInfoFee(Pointer<Void> txInfoPointer) {
  return bindings.SALVIUM_TransactionInfo_fee(txInfoPointer);
}

int getTransactionInfoConfirmations(Pointer<Void> txInfoPointer) {
  return bindings.SALVIUM_TransactionInfo_confirmations(txInfoPointer);
}

int getTransactionInfoBlockHeight(Pointer<Void> txInfoPointer) {
  return bindings.SALVIUM_TransactionInfo_blockHeight(txInfoPointer);
}

int getTransactionInfoTimestamp(Pointer<Void> txInfoPointer) {
  return bindings.SALVIUM_TransactionInfo_timestamp(txInfoPointer);
}
...
String getTransactionInfoLabel(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.SALVIUM_TransactionInfo_label(
    txInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getTransactionInfoDescription(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.SALVIUM_TransactionInfo_description(
    txInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getTransactionInfoPaymentId(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.SALVIUM_TransactionInfo_paymentId(
    txInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getTransactionInfoHash(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.SALVIUM_TransactionInfo_hash(
    txInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
int amountFromString(String amount) {
  ...
  try {
    return bindings.SALVIUM_Wallet_amountFromString(amountPointer);
  } finally {
...
bool setWalletCacheAttribute(
  ...
  try {
    return bindings.SALVIUM_Wallet_setCacheAttribute(
      walletPointer,
      keyPointer,
      valuePointer,
    );
...
String getWalletCacheAttribute(
  ...
  final keyPointer = key.toNativeUtf8().cast<Char>();
  try {
    final stringPointer = bindings.SALVIUM_Wallet_getCacheAttribute(
      walletPointer,
      keyPointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
Pointer<Void> restore14WordSeed({
  ...
  try {
    return bindings.SALVIUM_deprecated_restore14WordSeed(
      pathPointer.cast(),
...
Pointer<Void> create14WordSeed({
  ...
  try {
    return bindings.SALVIUM_deprecated_create14WordSeed(
      pathPointer,
      passwordPointer,
      languagePointer,
      networkType,
