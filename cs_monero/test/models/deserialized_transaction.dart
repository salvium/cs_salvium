...
void main() {
  group('DeserializedTransaction', () {
    test('should correctly deserialize a transaction hex string', () {
      ...
      final deserializedTx =
          DeserializedTransaction.deserialize(hexTransaction);
      ...
      expect(
        vin0.keyOffsets,
        equals([
          BigInt.from(93789954),
          BigInt.from(18110252),
          BigInt.from(1617409),
          BigInt.from(2405039),
          BigInt.from(804049),
          BigInt.from(3244020),
      ...
      expect(
        vin1.keyOffsets,
        equals([
          BigInt.from(59815436),
          BigInt.from(37517542),
          BigInt.from(18619639),
          BigInt.from(1584409),
          BigInt.from(2649486),
          BigInt.from(135193),
          BigInt.from(173142),
      ...
      expect(deserializedTx.vout.length, equals(4));
