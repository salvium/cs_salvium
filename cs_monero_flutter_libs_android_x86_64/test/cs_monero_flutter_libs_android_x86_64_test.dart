...
void main() {
  final CsMoneroFlutterLibsAndroidX8664Platform initialPlatform = CsMoneroFlutterLibsAndroidX8664Platform.instance;

  test('$MethodChannelCsMoneroFlutterLibsAndroidX8664 is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelCsMoneroFlutterLibsAndroidX8664>());
  });

  test('getPlatformVersion', () async {
    CsMoneroFlutterLibsAndroidX8664 csMoneroFlutterLibsAndroidX8664Plugin = CsMoneroFlutterLibsAndroidX8664();
    MockCsMoneroFlutterLibsAndroidX8664Platform fakePlatform = MockCsMoneroFlutterLibsAndroidX8664Platform();
    CsMoneroFlutterLibsAndroidX8664Platform.instance = fakePlatform;

    expect(await csMoneroFlutterLibsAndroidX8664Plugin.getPlatformVersion(), '42');
  });
}
